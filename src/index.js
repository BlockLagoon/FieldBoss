...
const seedArray = [
  "shGJUUTB89D1ed1ncfLTEZB9KatE5",  //inspector 1
  "snkP3PGmJoQ3smGkekaU3pehjtdtH",  //inspector 2
  "snJf73Tstd6HHaJr2TH2tniU9apeG",  //inspector 3
];
...
function SetCamera() {
  ...
  imageObj.src = "src/img/UTP-" + randint.toString() + ".jpg";
